...
<button type="button" class="btn btn-success add-side w-100" data-toggle="modal" data-target="#addSide">
    Bijgerechten toevoegen
</button>

<!-- Modal -->
<div class="modal fade" id="addSide" tabindex="-1" role="dialog" aria-labelledby="addSideLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addSideLabel">Bijgerecht toevoegen</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form  id="addSide" action="{{route('add_side')}}" method="post">
                @csrf
