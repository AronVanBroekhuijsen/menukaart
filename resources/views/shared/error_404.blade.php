...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased text-center">
        ...
        <div class="text-primary" style="margin-top:45vh;">
            <h1>404 - Error</h1>
            <p>Page not found</p>
        </div>

        <a class="back-button" href="/@if(isset($_GET['lang']))?lang={{$_GET['lang']}}@endif"><i class="fa-solid fa-share fa-2xl fa-rotate-180"></i></a>
